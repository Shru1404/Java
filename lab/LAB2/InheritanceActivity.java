...
class Manager extends Employee { //Derived Class Manager extending Employee Class
    public Manager(long employeeId, String employeeName, String employeeAddress, long employeePhone, double basicSalary) { //Overloaded Constructor of Manager Class which takes the parameters and initializes them to their respective variables in the super class
    ...
    public void calculateTransportAllowance() { //Overriding the method because Travel Allowance is 15% for the Manager
        double transportAllowance = 0.15 * basicSalary;
        System.out.println(transportAllowance);
    }
}
class Trainee extends Employee {
    public Trainee(long employeeId, String employeeName, String employeeAddress, long employeePhone, double basicSalary) { //Overloaded Constructor of Trainee Class which takes the parameters and initializes them to their respective variables in the super class
        super(employeeId, employeeName, employeeAddress, employeePhone, basicSalary);
        this.employeeId = employeeId;
        this.employeeName = employeeName;
        this.employeeAddress = employeeAddress;
